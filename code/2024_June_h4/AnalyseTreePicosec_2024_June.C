...
#include "MyFunctions_2024_June.C"
#include "../RMS_Baseline_Calculator/RMSBaselineCalculator_2024_June.cpp"
#include <iomanip>
#include <iostream>



int AnalyseTreePicosec_2024_June(int runNo=15, int poolNo=2, int draw=0, double threshold = 10.0, double peTh = 12.0, bool isCalibration = 0, string filetype = "")
{
  cout<<"RunNo= " <<runNo<< " poolNo = "<<poolNo<<endl;

  gROOT->LoadMacro("MyFunctions_2024_June.C");
