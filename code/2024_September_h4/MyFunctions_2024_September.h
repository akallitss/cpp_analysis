#ifndef MYFUNCTIONS_2024_SEPTEMBER_H
#define MYFUNCTIONS_2024_SEPTEMBER_H 1
...
const char *CODEDIR="/afs/cern.ch/user/a/akallits/PicoAnalysis/cpp_analysis/code/2024_September_h4";
const char *BASEDIRNAME="/eos/project-p/picosec/Saclay/data/2024_September_h4";
const char *WORKDIR="/eos/project-p/picosec/analysis/Saclay/data/2024_September_h4/wdir";
const char *PLOTDIR="/eos/project-p/picosec/analysis/Saclay/data/2024_September_h4/plots";
const char *DATADIRNAME="/eos/project-p/picosec/analysis/Saclay/data/2024_September_h4/dataTrees";
const char *OUTDIRNAME="/eos/project-p/picosec/analysis/Saclay/data/2024_September_h4/processedTrees";
const char *PARAMDIRNAME="/eos/project-p/picosec/analysis/Saclay/data/2024_September_h4/processedTrees/ParameterTrees";
const char *TRACKDIRNAME="/eos/project-p/picosec/testbeam/2024_September_h4/tracker/reconstructed";
...
const char *DATA_PATH_NAME="/eos/project-p/picosec/testbeam/2024_September_h4/";
